                        ...
                        <div class="blog-single">
                            <article class="post">
                                <div class="post-thumb">
                                    <img loading="lazy" class="img-responsive" src="/images/videos/snowman-sia.jpg" alt="Snowman de Sia por SAXONARA en Estany d'Ivars i Vila-sana">
                                </div>
                                <div class="post-content">
                                    ...
                                    <div class="post-entry">
                                        <p>Versión instrumental en saxofón de la canción Snowman de Sia, grabada en el Estany d'Ivars i Vila-sana tras la primera nevada del 2021.</p>

                                        <div class="gallery column-4">
                                            <div class="col-md-12 col-xs-12">
                                                <div class="video-item">
                                                    <iframe data-adapt-container-width="true" src="https://www.youtube.com/embed/iDwxmEka1vo" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                                </div>
                                            </div>
                                        </div>
