                ...
                <div class="row">
                    <div class="col-md-6 col-md-push-6 col-xs-12 col-xs-push-0">
                        <div class="about-artist">
                            ...
                            <p><b>Saxofonista professional de Girona amb una llarga experiència sobre els escenaris, també com a músic per a bodes, esdeveniments i festes.</b></p>
                            ...
                            <p>Se'ns dubte Girona és una ciutat amb un encant especial, qui no s'ha enamorat del seu casc històric o les vistes desde la muralla? A mi m'encanta posar música als <strong>esdeveniments</strong> que s'hi realitzen, bé siguin <strong>esdeveniments corporatius</strong> d'empreses de Girona o bodes i concerts en llocs singulars. Girona compta també amb un entorn privilegiat per realitzar-hi <strong>bodes</strong>, amb fincas històriques i hotels davant el mar.</p>
                            <div class="artist-information-list">
                                ...
                                <p><b class="artist-info-item">Saxofonista a</b>:<span class="artist-info-value">Girona</span></p>
                    ...
                    <div class="col-md-6 col-md-pull-6 col-xs-12 col-xs-pull-0">
                        <div class="artist-image">
                            <img loading="lazy" class="img-responsive" src="/images/cities/saxofonista-girona.jpg" alt="l'Arnald SAXONARA és saxofonista a Girona">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-sm-5">
                        <div class="doing-items section-padding">
                            <div class="section-header">
                                <h2 class="section-title">SAXONARA a Girona</h2>
                                <p class="section-subtext">La major part de les meves actuacions com a <strong>saxofonista per esdeveniments</strong> les realitzo a la mateixa ciutat de Girona o per la província (Roses, Banyoles, Olot, Lloret de Mar, La Bisbal d'Empordà...), però també em desplaço per tota Catalunya. Girona és el lloc perfecte per fer-hi festes i a mi m'encanta participar-hi com a <strong>saxofonista professional</strong>.</p>
                            </div>
                            <div class="doing-item">
                                ...
                                <p class="doing-text">Esdeveniments d'empreses de Girona, festes privades, <strong>inauguracions de botigues</strong> o Team Builings en àtics de la ciutat són alguns dels esdeveniments en els que he participat com a <strong>saxofonista a Girona</strong>.</p>
                            </div>
                            <div class="doing-item">
                                <div class="doing-icon">
                                ...
                                <p class="doing-text">La gran majoria de les <strong>bodes a Girona</strong> es duen a terme a la província, en finques com el Castell d'Empordà a La Bisbal d'Emporda, l'Almadraba Park Hotel a Roses, El Cortal Gran a Sant Martí d'Empúries, també <b>bodes a la platja davant el mar</b> a Empuriabrava o Begur, i llocs únics com el Castell de Peralada, a 40' de Girona. Si busques un <strong>saxofonista per a bodes a Girona</strong> em pots esciure a SAXONARA.</p>
                            </div>
                            <div class="doing-item">
                                <div class="doing-icon">
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 col-xs-12">
                        <div class="section-header text-center">
                            <h3 class="section-title">Enregistraments a Girona</h3>
                            <p class="section-subtext">Descobreix alguns dels meus videoclips grabats a Girona, on us ensenyo com són les experiències de realitzar esdeveniments a la capital de Catalunya, <strong>saxofonista a a bodes i festes</strong> en racons singulars que no tots el gironins coneixen. Per a l'enregistrament d'aquests vídeos utilitzo diferents saxòfons, principalment el saxòfon tenor i l'alt, però també el soprano per a moments més íntims com una <strong>Cerimònia de boda</strong>.</p>
                        </div>
                    </div>
                </div>

                <?php include "../common-php/videos/loc-girona.html"; ?>
