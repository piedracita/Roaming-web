                ...
                <div class="row">
                    <div class="col-md-6 col-md-push-6 col-xs-12 col-xs-push-0">
                        <div class="about-artist">
                            ...
                            <p><b>Saxofonista professional de Lleida amb una llarga experiència sobre els escenaris, també com a músic per a bodes, esdeveniments i festes.</b></p>
                            <p>Hola! Sóc l'Arnald SAXONARA, <strong>saxofonista professional</strong> de  Lleida amb anys d'experiència sobre els escenaris, tocant diferents estils i cursant en acadèmies de Lleida, Estats Units, Puerto Rico i Argentina. Se'm coneix pel nom artístic de SAXONARA com a <strong>saxofonista per a bodes i esdeveniments</strong> on combino la música al saxòfon amb espectacles i shows divertits, buscant la interacció amb els convidats.</p>
                            <p>Tot i viatjar moltísim amb la música, sempre m'agrada tocar a casa, a Lleida, una ciutat amb molt potencial i varietat en el territori, amb sales de concerts, <strong>esdeveniments d'empresa</strong> i <strong>bodes</strong>. Us convido a descobrir les finques repartides pel territori lleidatà, un entorn privilegiat per a <strong>bodes</strong> i esdeveniments singulars.</p>
                            <div class="artist-information-list">
                                ...
                                <p><b class="artist-info-item">Saxofonista a</b>:<span class="artist-info-value">Lleida</span></p>
                    ...
                    <div class="col-md-6 col-md-pull-6 col-xs-12 col-xs-pull-0">
                        <div class="artist-image">
                            <img loading="lazy" class="img-responsive" src="/images/cities/saxofonista-lleida.jpg" alt="l'Arnald SAXONARA és saxofonista a Lleida">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-sm-5">
                        <div class="doing-items section-padding">
                            <div class="section-header">
                                <h2 class="section-title">SAXONARA a Lleida</h2>
                                <p class="section-subtext">La major part de les meves actuacions com a <strong>saxofonista per esdeveniments</strong> les realitzo a la mateixa ciutat de Lleida o les seves veïnes Sant Cugat, Castelldefels, Lloret de Mar o Sitges, però també em desplaço per tota Catalunya. Lleida és el lloc perfecte per fer-hi festes i a mi m'encanta participar-hi com a <strong>saxofonista professional</strong>.</p>
                            </div>
                            <div class="doing-item">
                                ...
                                <p class="doing-text">Esdeveniments d'empreses de Lleida, festes privades, <strong>inauguracions de botigues</strong>, Team Builings en àtics de la ciutat o <strong>passejades de vaixell pel Mediterrani</strong> són alguns dels esdeveniments en els que he participat com a <strong>saxofonista a Lleida</strong>.</p>
                            </div>
                            <div class="doing-item">
                                <div class="doing-icon">
                                ...
                                <p class="doing-text">La gran majoria de les <strong>bodes a Lleida</strong> es duen a terme a les afores de la ciutat, en finques de Sant Cugat o pujant al Montseny, també <b>bodes a la platja davant el mar</b> a Castelldefels o Sitges, i llocs únics com el Poble Espanyol amb vistes a Lleida. Si busques un <strong>saxofonista per a bodes a Lleida</strong> em pots esciure a SAXONARA.</p>
                            </div>
                            <div class="doing-item">
                                <div class="doing-icon">
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 col-xs-12">
                        <div class="section-header text-center">
                            <h3 class="section-title">Enregistraments a Lleida</h3>
                            <p class="section-subtext">Descobreix alguns dels meus videoclips grabats a Lleida, on us ensenyo com són les experiències de realitzar esdeveniments a la capital de Catalunya, <strong>saxofonista a a bodes i festes</strong> en racons singulars que no tots el lleidatans coneixen. Per a l'enregistrament d'aquests vídeos utilitzo diferents saxòfons, principalment el saxòfon tenor i l'alt, però també el soprano per a moments més íntims com una <strong>Cerimònia de boda</strong>.</p>
                        </div>
                    </div>
                </div>

                <?php include "../common-php/videos/loc-lleida.html"; ?>
